...
function heroSlideShow() {
  var listaImgBg = [
    //ojo con el path, si estas desde JS tiene que ser como si fuera del HTML
    "url('./media/header1.jpg')",
    "url('./media/header2.jpg')",
    "url('./media/header3.jpg')",
  ];
  bgCounter++;

  if (bgCounter == listaImgBg.length) {
    //if para reinicializar
    bgCounter = 0;
  }
